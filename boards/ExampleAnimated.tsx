...
import { urbanears_blue, urbanears_pink, urbanears_grey, logo } from '../zetup/require';


const data = [
  {
    type: 'Humlan P',
    imageUri: urbanears_blue,
...
const Circle = ({ scrollOffsetAnimatedValue }: { scrollOffsetAnimatedValue: Animated.Value }) => {
  return (
